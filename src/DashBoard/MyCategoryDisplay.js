...
export class MyCategoryDisplay extends Component {
  state = {
    record: []
};
constructor(props) {
...
deleteRecord = (categoryid) => {
    axios.delete(`http://localhost:5000/api/admin/mycategory/${categoryid}`)
      .then((result) => {
        this.onDisplay();
    })
      .catch(() => {
                ...
                <div style={{ height: "100%" }}>
                    <div style={{ padding: "20px 5%", height: "calc(100% - 64px)", overflowY: "scroll" }}>
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(1, minmax(200px, 700px))" }}>
                            <div className="mt-5">
                                <h4 className="font-weight-bold mb-3">MyCategory</h4>
                                <a className="btn" href="/MyCategoryInsert" ><i className="fas fa-plus">Add MyCategory</i></a>
                                <CDBTable hover responsive>
                                    <CDBTableHeader>
                                        <tr>
                                            <th>#</th>
                                            <th>MyCategoryName</th>
                                            <th>Description</th>
                                            <th>Action</th>
                                        </tr>
                                    </CDBTableHeader>
...
export default MyCategoryDisplay;
